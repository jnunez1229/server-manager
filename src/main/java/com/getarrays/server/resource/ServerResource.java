...
import com.getarrays.server.service.implementation.ServerServiceImpl;
...
public class ServerResource {
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(System.getProperty("user.hpme") + "Downloads/images/" + fileName));
    }
